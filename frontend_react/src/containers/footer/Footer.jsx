    ...
    <>
      ...
      <div className="app__contact-cards">
        <a
          ...
          href="mailto:ysfhmza10@gmail.com"
          target="_blank"
          rel="noreferrer"
        >
          <AiTwotoneMail />
          <p className="p-text">ysfhmza10@gmail.com</p>
        </a>
        <a
          className="app__contact-whatsapp"
          href="https://wa.me/+201095470920"
          target="_blank"
          rel="noreferrer"
        >
          <BsWhatsapp />
        ...
        <a
          className="app__contact-phone"
          href="tel://+201095470920"
          target="_blank"
          rel="noreferrer"
        >
          <BsFillPhoneFill />
        ...
        <a
          className="app__contact-github"
          href="https://github.com/yousefhmza"
          target="_blank"
          rel="noreferrer"
        >
          <BsGithub />
